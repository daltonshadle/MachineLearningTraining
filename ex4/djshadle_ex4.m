% This is my code for exercise 4
...
% Weight regularization parameter (we set this to 0 or 1 here).
% Expected value for 0 = 0.287629
% Expected value for 1 = 0.383770
lambda = 1;
