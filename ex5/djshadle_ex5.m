% This is my code for exercise 5
...
% Expected gradient of [-15.30; 598.250]
...
%% ************************** Effect of Lambda ****************************
% Choose the value of lambda: 1, 100
lambda = 100;
[theta] = trainLinearReg(X_poly, y, lambda);
...
%% ****************** Plotting Learning Curve with Random *****************
lambda = 0.01;
[error_train, error_val] = learningCurve(X_poly, y, X_poly_val, yval, lambda);
plot(1:m, error_train, 1:m, error_val);
